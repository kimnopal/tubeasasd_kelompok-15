...
def main():
    ...
    while True:
        # membuat frame kamera
        success, img = cap.read()

        # membuat image baru yang sudah mendeteksi tangan
        ...
        # menambahkan text fps ke image
        cv2.putText(img, str(int(fps)), (10, 70),
                    cv2.FONT_HERSHEY_PLAIN, 3, (255, 0, 255), 3)

        # merender image dan menajalankan webcam
        cv2.imshow("Image", img)
        cv2.waitKey(1)


# jika menjalankan script ini
